--[[------------------------------------------------------
  ...
  available with lut.Doc. This first paragraph is output as "summary".
...
local lib = class 'lut.DocTest'


-- # Create

-- Creating an lut.DocTest is done by providing a table of parameters. 
--
-- Usage example:
--
--   require 'lubyk'
